...
const levels = [
  ...
  },
  {
    ...
    topics: ["AND/OR", "NULL", "LIKE", "Aggregate Functions"],
    status: "available",
  },
  {
    level: 3,
  ...
  },
  {
    ...
    topics: ["Scalar Subqueries", "Correlated", "WITH Clause", "Recursive Basics"],
    status: "locked",
  },
  {
    level: 5,
    title: "Window Functions",
    topics: ["ROW_NUMBER", "RANK", "LAG/LEAD", "PARTITION BY"],
    status: "locked",
  },
  {
    level: 6,
    title: "Performance",
    topics: ["Indexes", "Transactions", "EXPLAIN", "Optimization"],
    status: "locked",
  },
  {
    level: 7,
    title: "Advanced",
    topics: ["Recursive CTEs", "JSON in SQL", "Partitioning", "Materialized Views"],
    status: "locked",
  },
];
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {level.topics.map((topic) => (
                      <span
                        key={topic}
                        className="px-2 py-0.5 text-xs rounded bg-secondary text-muted-foreground font-mono"
                      >
                        {topic}
                      </span>
                    ))}
